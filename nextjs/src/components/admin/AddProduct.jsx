...
const AddProduct = () => {
  ...
  const handleAddCategory = (value) => {
    ...
    // Check if it's a custom category (not in DEFAULT_CATEGORIES)
  ...
  const handleDeleteCategory = (category) => {
    setCategories((prev) => {
      ...
      // Update localStorage if it's a custom category
          ...
          <div className="form-grid two-col">
            <div className="form-group">
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="e.g., 100% Cotton. Wash in cold water. Do not bleach."
                rows="3"
              />
            </div>
        ...
        <div className="form-section full-width">
          ...
          <div className="form-grid two-col">
            ...
            <div className="form-group">
              ...
              <div
                className={`quick-image-drop-zone ${quickDragActive ? 'drag-active' : ''}`}
              ...
              >
                {quickImagesUploading ? (
                  ...
                  <div className="drop-hint">
                    Drag & drop image files here, or click to browse (Max 2 images per upload)
                  </div>
                )}
